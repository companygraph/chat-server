...
// since 0.13.3 with the chat rule naming the website as the model's too. Kept
...
test("the prompt is the host's instructions, then the types, then the rules, then the language", () => {
  ...
  assert.ok(RULES.some((r) => r.includes("A question about this website, its pages, its sections, what it shows, is a question about this model too") && r.includes("describes the website as a surface")), "the site-is-in-the-model sentence is missing");
