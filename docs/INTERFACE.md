...
| `cite` | `{ id, title, type, url }` | a tool answered with one entity, or evidence for one skill; the widget links it, and an entity cited already in this message is not cited twice |
